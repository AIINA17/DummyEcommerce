  ...
  return (
    <div className="page-container state-screen">
      ...
      <p className="state-text">
        Sepertinya kamu belum berbelanja apapun hari ini.
      </p>
      <Link href="/">
        <button className="btn btn-primary">
          <ShoppingBag size={15} /> Cari Produk
        </button>
      </Link>
    </div>
  );
...
function EmptyTabState() {
  return (
    <div className="state-screen" style={{ minHeight: 160 }}>
      <p className="state-text">Tidak ada pesanan di kategori ini.</p>
    </div>
  );
}
    ...
    <article className="card" style={{ animationDelay: `${index * 0.05}s` }}>
      ...
      <div className="card-footer">
        ...
        <div>
          ...
          <p className="card-footer-total-value">
      ...
      >
        <button className="btn btn-secondary btn-full">
          Lihat Detail Pesanan <ChevronRight size={14} />
        </button>
      </Link>
    </article>
  );
