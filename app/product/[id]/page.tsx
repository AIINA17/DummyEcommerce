...
export default function ProductDetail() {
  ...
  return (
    <div className="page-container">
      ...
      {/* ── Content ── */}
      <main
        style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 24px 80px" }}
      >
        {/* Product Card */}
        <article
          className="card"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span className={`status-badge ${stockInfo.cls}`}>
            ...
            <div>
              ...
              >
                Maksimal {product.stock} unit tersedia
              </p>
            </div>
